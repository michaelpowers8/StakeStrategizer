...
internal class BaccaratReverseEngineer
{
    ...
    internal BaccaratReverseEngineer(ProvablyFairAlgorithm algorithm)
    {
    ...
    {
        return _algorithm.RandomStakeNumbers(Enumerable.Repeat(BytesToNumberMultiplier, 6).ToList());
    }
    ...
    internal List<string> GetBaccaratDeck()
    {
