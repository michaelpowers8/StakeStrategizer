...
internal class HiloReverseEngineer
{
    ...
    internal HiloReverseEngineer(ProvablyFairAlgorithm algorithm)
    {
    ...
    {
        return _algorithm.RandomStakeNumbers(Enumerable.Repeat(BytesToNumberMultiplier, 100).ToList());
    }
    ...
    internal List<string> GetHiloDeck()
    {
